...
public class generacional {
    ...
    public generacional(int nDimension, String fileName, int nIte, int arandomSeed, int population, int maxIteracionesSinMejora, float nProbMut, float nProbCruce, int crossType) {
                ...
                if (crossProb < probMut) {
                    ...
                    if (tipoCruce == 0) {
                        ...
                        do {
                            ...
                            if (!firstUsedValues.contains(nextGen.get(match).get(loc_padre2))) {

                                boolean freeSpot = false;
                                int nextUnit = nextGen.get(i).get(loc_padre2);
                                ...
                                do {
                                    ...
                                    if (firstSon.get(nextUnit) == (-1)) {
                                        ...
                                        do {
                                            if (nextGen.get(match).get(j) == nextUnit) {
                                                located = true;
                                            } else {
                                                j++;
                                            }
                                        ...
                                        nextUnit = nextGen.get(i).get(j);
                                    }

                                } while (!freeSpot);

                                firstSon.set(nextUnit, nextGen.get(match).get(loc_padre2));
                                firstUsedValues.add(nextGen.get(match).get(loc_padre2));
                                usedValues++;
                            }
                        ...
                        do {
                            ...
                            if (!secondUsedValues.contains(nextGen.get(i).get(loc_padre2))) {

                                boolean freeSpot = false;
                                int nextUnit = nextGen.get(match).get(loc_padre2);
                                ...
                                do {
                                    ...
                                    if (secondSon.get(nextUnit) == (-1)) {
                                        ...
                                        do {
                                            if (nextGen.get(i).get(j) == nextUnit) {
                                                located = true;
                                            } else {
                                                j++;
                                            }
                                        ...
                                        nextUnit = nextGen.get(match).get(j);
                                    }

                                } while (!freeSpot);

                                secondSon.set(nextUnit, nextGen.get(i).get(loc_padre2));
                                secondUsedValues.add(nextGen.get(i).get(loc_padre2));
                                usedValues++;
                            }
