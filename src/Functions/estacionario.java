...
public class estacionario {
    ...
    private String file;
    private int cruceTipo;

    public estacionario(int nDimension, String fileName, int nIte, int arandomSeed, int population, int maxIteracionesSinMejora, float nProbMutacion, int cruce) {
    ...
    public int estacionarioSolucion(int[][] fluxMatrix, int[][] distMatrix) {
        ...
        while (iteraciones < maxIteraciones && generacionesSinMejora != maxIteSinMejora) {
            ...
            pos1 = Math.abs(rand.nextInt(nPopulation));

            do {
                pos2 = Math.abs(rand.nextInt(nPopulation));
            } while (pos1 == pos2);

            do {
                pos3 = Math.abs(rand.nextInt(nPopulation));
            } while (pos3 == pos2 || pos3 == pos1);

            do {
                pos4 = Math.abs(rand.nextInt(nPopulation));
            ...
            if (cruceTipo == 0) {
                ...
                // Paso 4: Una vez hecho esto, partiendo del mismo rango buscar comprobar si no son comunes y a�adirlos a la nueva soluci�n (HIJO 1)
                ...
                do {
                    ...
                    if(!firstUsedValues.contains(secondWinner.get(loc_padre2))){
                        ...
                        // Buscamos la posici�n en le corresponde
                ...
                do {
                    ...
                    if (!secondUsedValues.contains(firstWinner.get(loc_padre2))) {
